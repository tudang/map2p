...
public class SharedDirectory
{
	...
	SharedDirectory.savepath = new File(savepath);
    }
    ...
    public static void sharefilesList() {
        Collections.sort(filestoshare);
        for (Iterator it = filestoshare.iterator(); it.hasNext();) {
